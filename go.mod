...
replace (
	...
	// go.opentelemetry.io/ebpf-profiler => github.com/DataDog/opentelemetry-ebpf-profiler v0.0.0-20260512132452-a0f6335b5e2e
	go.opentelemetry.io/ebpf-profiler => ../opentelemetry-ebpf-profiler
)
...
require (
	...
	github.com/DataDog/rshell v0.0.15
